...
static const int RXPin = 13, TXPin = 15;                    // Ublox 6m GPS module to pins 12 and 13
static const uint32_t GPSBaud = 4800;                       // Ublox GPS default Baud Rate is 9600

TinyGPSPlus gps;                                            // Create an Instance of the TinyGPS++ object called gps
SoftwareSerial ss(RXPin, TXPin);                            // The serial connection to the GPS device

const double HOME_LAT = 23.4607;                          // Enter Your Latitude and Longitude here
const double HOME_LNG = 91.1809;                         // to track how far away the "Dog" is away from Home 

/************************* WiFi Access Point *********************************/

#define WLAN_SSID       "repeater"                          // Enter Your router SSID
#define WLAN_PASS       "sakibtuhinnitu"                        // Enter Your router Password

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                                // use 8883 for SSL
#define AIO_USERNAME    "bueteeeproject"                          // Enter Your Adafruit IO Username
#define AIO_KEY         "aio_TCbI50VpU0fPx2jDnPVeVg50NRSr"  // Enter Your Adafruit IO Key
